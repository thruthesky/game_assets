...
팀원이 g.blend 로부터 sheet.py 로 구운 TexturePacker atlas 를 이 폴더에 넣으세요.
...
결과물:
  assets/pc/g/g.png      (아틀라스 페이지, 멀티페이지면 g2.png, g3.png …)
  assets/pc/g/g.atlas    (region 정의: idle_E, walk_E, attack_S … {action}_{16방향라벨})

이 폴더에 g.atlas + g.png 를 복사한 뒤 `flutter run` 을 다시 하면(hot reload 아님, 재빌드),
